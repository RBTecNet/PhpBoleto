...
namespace Rbtecnet\Phpboleto\Boleto;
use Carbon\Carbon;
use Rbtecnet\Phpboleto\Boleto\Render\Pdf;
use Rbtecnet\Phpboleto\Boleto\Render\PdfCaixa;
use Illuminate\Support\Str;
use Rbtecnet\Phpboleto\Util;
use Rbtecnet\Phpboleto\Contracts\Boletos\Boleto as BoletoContract;
use Rbtecnet\Phpboleto\Contracts\Pessoa as PessoaContract;
...
abstract class AbstractBoleto implements BoletoContract
{
    ...
    public function setNotaFiscal($notafiscal){
        $this->notafiscal = (string)$notafiscal;
        return $this;
    }
    ...
    public function setMoedaExtenso($moedaextenso){
        $this->moedaextenso = (string)$moedaextenso;
        return $this;
    }

    public function getMoedaExtenso(){
        return $this->moedaextenso;
    }

    public function setParcela($parcela){
        $this->parcela = (string)$parcela;
        return $this;
    }
    ...
    public function setAcrescimo($acrescimo){
        $this->acrescimo = (string)$acrescimo;
        return $this;
    }
