<?php
namespace Rbtecnet\Phpboleto\Boleto\Banco;
...
use Rbtecnet\Phpboleto\Contracts\Boletos\BoletoApi as BoletoAPIContract;
use Rbtecnet\Phpboleto\Contracts\Boletos\Boleto;
