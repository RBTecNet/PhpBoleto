<?php
namespace Rbtecnet\Phpboleto\Cnab\Retorno;

use Rbtecnet\Phpboleto\Contracts\Cnab\Retorno\Cnab400\Detalhe as Detalhe400Contract;
use Rbtecnet\Phpboleto\Contracts\Cnab\Retorno\Cnab400\Trailer as Trailer400Contract;
use Rbtecnet\Phpboleto\Contracts\Cnab\Retorno\Cnab400\Header as Header400Contract;
...
abstract class AbstractRetorno implements \Countable, \SeekableIterator
{
    ...
    public function __construct($file)
    {
        ...
        $r = new \ReflectionClass('Rbtecnet\Phpboleto\Contracts\Boletos\Boleto');
